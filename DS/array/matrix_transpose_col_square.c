...
void transpose_matrix(int no_of_rows_of_matrix, int no_of_cols_of_matrix, int myarray[no_of_rows_of_matrix][no_of_cols_of_matrix])
{
  int i = 0, j = 0, sum_of_square = 0;
...
int main()
{
  ...
  printf("++++++++++++++++++++++++++++++++++++++++++++\n");
  transpose_matrix(no_of_rows_of_matrix, no_of_cols_of_matrix, myarray);
  printf("++++++++++++++++++++++++++++++++++++++++++++\n");
  for(i=0;i<no_of_rows_of_matrix;i++)
  {
    for(j=0;j<no_of_cols_of_matrix;j++)
