...
void sum_of_above_diagonal(int no_of_rows_of_matrix, int no_of_cols_of_matrix, int myarray[no_of_rows_of_matrix][no_of_cols_of_matrix])
{
  int i = 0, j = 0, sum = 0;
...
int main()
{
  ...
  printf("++++++++++++++++++++++++++++++++++++++++++++\n");
  sum_of_above_diagonal(no_of_rows_of_matrix, no_of_cols_of_matrix, myarray);
  return 0;
}
